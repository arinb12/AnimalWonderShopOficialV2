...
import com.anws.domain.Usuario;
import com.anws.service.CorreoService;
import com.anws.service.RegistroService;
import com.anws.service.UsuarioService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    private String demeClave() {  //string con tira de caracteres
        String tira = "ABCDEFGHIJKLMNOPQRSTUXYZabcdefghijklmnopqrstuvwxyz0123456789_*+-";
        String clave = "";
        for (int i = 0; i < 40; i++) {  //for para crear una clave random cuando al usuario se le olvida la contraseña
    ...
    @Value("${servidor.http}") //enviar info del aplication properties a nuestro codigo     
