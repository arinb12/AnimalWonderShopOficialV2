...
import com.anws.service.FirebaseStorageService;
import java.io.File;
...
public class FirebaseStorageServiceImpl implements FirebaseStorageService {
    ...
    public String cargaImagen(MultipartFile archivoLocalCliente, String carpeta, Long id) {
        try {
            ...
            // Se genera el nombre segÃƒÂºn el cÃƒÂ³digo del articulo. 
            ...
            // se copia a Firestore y se obtiene el url vÃƒÂ¡lido de la imagen (por 10 aÃƒÂ±os) 
    ...
    //MÃƒÂ©todo utilitario que convierte el archivo desde el equipo local del usuario a un archivo temporal en el servidor
    ...
    //MÃƒÂ©todo utilitario para obtener un string con ceros....
